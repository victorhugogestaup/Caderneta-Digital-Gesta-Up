...
const schemas: Record<string, Joi.ObjectSchema> = {
  ...
  rodeio: Joi.object({
    ...
    escoreGadoIdealObs: Joi.string().allow(''),
    bebedourosCochos: Joi.string().valid('S', 'N').required(),
    bebedourosCochosObs: Joi.string().allow(''),
    pastagensTaxaLotacao: Joi.string().valid('S', 'N').required(),
    pastagensTaxaLotacaoObs: Joi.string().allow(''),
    animaisMachucadosDoentesBichados: Joi.string().valid('S', 'N').required(),
    animaisMachucadosDoentesBichadosObs: Joi.string().allow(''),
    cercasCochosPorteiras: Joi.string().valid('S', 'N').required(),
    cercasCochosPorteirasObs: Joi.string().allow(''),
    carrapatosMoscas: Joi.string().valid('S', 'N').required(),
    carrapatosMoscasObs: Joi.string().allow(''),
    animaisEntreverados: Joi.string().valid('S', 'N').required(),
    animaisEntreveradosObs: Joi.string().allow(''),
    animalMorto: Joi.string().valid('S', 'N').required(),
    animalMortoObs: Joi.string().allow(''),
