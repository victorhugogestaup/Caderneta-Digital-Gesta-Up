  ...
  switch (store) {
    ...
    case 'rodeio':
      return {
        ...
        bebedouros_cochos: registro.bebedourosCochos === 'S' || registro.bebedourosCochos === 'Sim',
        bebedouros_cochos_obs: registro.bebedourosCochosObs || null,
        pastagens_taxa_lotacao: registro.pastagensTaxaLotacao === 'S' || registro.pastagensTaxaLotacao === 'Sim',
        pastagens_taxa_lotacao_obs: registro.pastagensTaxaLotacaoObs || null,
        animais_machucados_doentes_bichados: registro.animaisMachucadosDoentesBichados === 'S' || registro.animaisMachucadosDoentesBichados === 'Sim',
        animais_machucados_doentes_bichados_obs: registro.animaisMachucadosDoentesBichadosObs || null,
        cercas_cochos_porteiras: registro.cercasCochosPorteiras === 'S' || registro.cercasCochosPorteiras === 'Sim',
        cercas_cochos_porteiras_obs: registro.cercasCochosPorteirasObs || null,
